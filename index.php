...
<html class="no-js" lang="zxx">
   <head>
      ...
      <title>Lensiora | Capturing Stories Through the Lens</title>
      <meta name="description" content="Lensiora is a professional photography studio capturing real moments, emotions, and stories through creative and timeless photography.">
                     ...
                     <div class="col-xl-9 col-lg-10">
                        <div class="main-menu black-menu menu-bg-white d-none d-lg-block">
                           <div class="hamburger hamburger--collapse is-active">
                              <a href="telto:+1 (540) 615-2198" style="color:black; border: 1px solid #cac0c0; padding: 5px;">+1 (540) 615-3098</a>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-lg-4 col-md-7 col-sm-8">
                              <div class="slide-content2">
                                 ...
                                 <p>Capturing journeys, cultures, and unforgettable moments from every corner of the world.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-lg-4 col-md-7 col-sm-8">
                              <div class="slide-content2">
                                 ...
                                 <p>Freezing rare and powerful moments of nature in its purest and most raw form.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-lg-4 col-md-7 col-sm-8">
                              <div class="slide-content2">
                                 <h4>
                                    <dd>03</dd>
                                    <span>Urban Stories</span>
                                 </h4>
                                 <p>Turning everyday city life into stunning visual stories through creative photography.</p>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row justify-content-between align-items-center">
                  <div class="col-lg-6">
                     <div class="section-tittle mb-50">
                        <h2>With my camera, I capture the beauty of everyday life</h2>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="section-tittle mb-60">
                        <p>Every moment has a story to tell — from simple daily scenes to unforgettable experiences. Through my lens, I turn real life into timeless memories you can feel and relive..</p>
                     </div>
                  </div>
               </div>
         ...
         <div class="all-starups-area fix" id="about">
            ...
            <div class="starups">
               <div class="starups-details">
                  <h3>I’m Ready to Go Beyond Expectations</h3>
                  <p>With every project, I aim to deliver more than just photos — I create experiences that leave a lasting impression. From the first click to the final frame, my focus is always on quality, creativity, and results that truly stand out.</p>
               ...
               <div class="row justify-content-center">
                  <div class="col-lg-10">
                     <div class="section-tittle mb-60 text-center">
                        <h2>Life is About Creating Meaningful Experiences</h2>
                        <p>Every moment holds the power to become a memory. Through thoughtful photography and creative storytelling, I help turn real experiences into moments you’ll treasure forever.</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                     ...
                     <div class="h1-testimonial-active dot-style">
                        ...
                        <div class="single-testimonial position-relative">
                           <div class="testimonial-caption">
                              ...
                              <p>
                                 "Working with this photography team was an amazing experience. Every moment was captured with creativity, care, and attention to detail. The final photos truly exceeded our expectations."
                              </p>
                           </div>
                           <!-- founder -->
                        ...
                        <div class="single-testimonial position-relative">
                           <div class="testimonial-caption">
                              <img src="assets/img/icon/quotes-sign.png" alt="" class="quotes-sign">
                              <p>
                                 "From the first consultation to the final delivery, everything was smooth and professional. The photos captured real emotions beautifully. Highly recommended!"
                              </p>
                           </div>
                           <!-- founder -->
                           <div class="testimonial-founder d-flex align-items-center">
            ...
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-lg-10">
                     <div class="section-tittle mb-60 text-center">
                        <h2>Contact Us</h2>
                        <p>Have a project in mind or just want to say hello? We’d love to hear from you. Get in touch with us today and let’s create something amazing together.</p>
                     </div>
                  </div>
               </div>
               <div class="row">
